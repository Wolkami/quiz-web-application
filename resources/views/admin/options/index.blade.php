        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover {{ !$options->isEmpty() ? 'datatable datatable-option' : '' }}"
...
@push('script-alt')
    @include('partials.datatable', ['elements_type' => 'options', 'datatable_selector' => 'datatable-option'])
@endpush
